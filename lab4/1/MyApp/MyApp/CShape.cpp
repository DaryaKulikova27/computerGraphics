...
void CShape::SetSideColor(CubeSide side, const glm::vec4& color)
{
	unsigned index = static_cast<unsigned>(side);
	m_sideColors[index] = color;
}

void CShape::SetSpecularColor(glm::vec4 color)
{
	m_specularColor = color;
}

void CShape::SetShininess(float shininess)
{
